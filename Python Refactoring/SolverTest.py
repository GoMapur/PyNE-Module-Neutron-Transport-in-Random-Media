...
materials1 = Model_Material(thickness = 0.4, cross_section = 1.0, scattering_ratio = 1.0, homogeneous_isotropic_source = 0.0)
materials2 = Model_Material(thickness = 0.4, cross_section = 1.0, scattering_ratio = 1.0, homogeneous_isotropic_source = 0.0)
