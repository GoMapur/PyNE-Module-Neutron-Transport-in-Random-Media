...
bench = Model_1D_Stochastic_Finite_Step_Benchmark(total_len = 5.0, point_num = 50, boundary_cond = [0.0, 1.0], materials = [materials1, materials2], gauss_discrete_direction_num = 8)
bench.benchmark()
