...
bench = Model_1D_Homogeneous_Finite_Step_Benchmark(total_len = 4.0, point_num = 20, boundary_cond = [1.0, 0.0], materials = [materials1, materials2], gauss_discrete_direction_num = 4)
bench.benchmark()
